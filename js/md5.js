/*
 * JavaScript MD5, adapted from Joseph Myers' public-domain implementation
 * (https://www.myersdaily.org/joseph/javascript/md5-text.html).
 * Used only to build the ts+privateKey+publicKey hash the Marvel Comics API
 * requires on every request. See js/api.js for the disclaimer about moving
 * this server-side in production.
 */
(function (global) {
  ...
  global.md5 = function (s) { return rstr2hex(rstrMD5(str2rstrUTF8(s))); };
})(window);
